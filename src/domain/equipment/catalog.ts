...
export const STARTER_EQUIPMENT_CATALOG: readonly EquipmentCatalogItem[] = [
  ...
  },
  {
    ...
    rawRatingStatus: 'preserved', rawEquipmentRating: 'C/A-A-B/D', rawAvailabilityCodes: ['A', 'A', 'B'],
  ...
  },
  {
    ...
    rawRatingStatus: 'preserved', rawEquipmentRating: 'D/B-C-B/C', rawAvailabilityCodes: ['B', 'C', 'B'],
  ...
  },
  {
    ...
    rawRatingStatus: 'preserved', rawEquipmentRating: 'B/A-A-A/A', rawAvailabilityCodes: ['A', 'A', 'A'],
  ...
  },
  {
    ...
    rawRatingStatus: 'preserved', rawEquipmentRating: 'C/A-A-A/A', rawAvailabilityCodes: ['A', 'A', 'A'],
  ...
  },
  {
    ...
    rawRatingStatus: 'preserved', rawEquipmentRating: 'D/A-A-A/B', rawAvailabilityCodes: ['A', 'A', 'A'],
  ...
  },
  {
    ...
    rawRatingStatus: 'preserved', rawEquipmentRating: 'D/A-C-B/A', rawAvailabilityCodes: ['A', 'C', 'B'],
  ...
  },
  {
    ...
    ratings: { tech: 'C', availability: 'B', legality: 'A' }, affiliationCode: null, sourceKey: 'AToW-CTP-p306', source: source('AToW-CTP-p306', 306), sourceStatus: 'audited-core',
    rawRatingStatus: 'preserved', rawEquipmentRating: 'C/A-B-A/A', rawAvailabilityCodes: ['A', 'B', 'A'],
  ...
  },
  {
    ...
    ratings: { tech: 'D', availability: 'C', legality: 'A' }, affiliationCode: null, sourceKey: 'AToW-CTP-p306', source: source('AToW-CTP-p306', 306), sourceStatus: 'audited-core',
    rawRatingStatus: 'preserved', rawEquipmentRating: 'D/A-C-B/A', rawAvailabilityCodes: ['A', 'C', 'B'],
...
export function validateEquipmentCatalog(catalog: readonly EquipmentCatalogItem[] = EQUIPMENT_CATALOG): string[] {
  ...
  for (const item of catalog) {
    ...
    if (item.rawRatingStatus === 'not-supplied-in-audit') {
      if (item.rawEquipmentRating) issues.push(`Legacy raw-rating status conflicts with preserved rating: ${item.id}`)
      else issues.push(`Current catalog raw equipment rating is not preserved: ${item.id}`)
    }
