  ...
  return (
    <main>
      <section className="hero">
        <p className="eyebrow">Alpha · Slice 15</p>
        <h1>Character Creator</h1>
        <p>Create a sourced Core character through Archetype, Point Buy, or the narrow Life Modules v0.12 branch with final review, Final Touches, a hardened 75-item audited equipment catalog, affiliation-adjusted access, durable purchase snapshots, and manual fallback on one shared Character/Rules engine.</p>
      </section>
