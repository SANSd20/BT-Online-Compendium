  ...
  return (
    <main>
      <section className="hero">
        ...
        <p>Create a sourced Core character through Archetype, Point Buy, or the narrow Life Modules v0.8 branch with final review, Final Touches, and an audited starter-equipment catalog plus manual fallback on one shared Character/Rules engine.</p>
      </section>
