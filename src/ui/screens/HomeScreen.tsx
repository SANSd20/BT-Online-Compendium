  ...
  return (
    <main>
      <section className="hero">
        ...
        <p>Create a sourced Core character through Archetype, Point Buy, or the narrow Life Modules v0.4 Technical College branch on one shared Character/Rules engine.</p>
      </section>
