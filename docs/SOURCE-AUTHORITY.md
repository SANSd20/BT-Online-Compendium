...
The Alpha rules catalog records these three current sources as versioned metadata and captures them in each new character's creation-rules snapshot. Alpha Slice 2 adds the eight published Core archetype packages from Corrected Third Printing pages 52–59. Alpha Slice 3 adds the focused Point Buy foundation from Core pages 49, 51, 60, 95, 107, and 121–122. Alpha Slice 4 adds the initial Stage 0/1 modules, Alpha Slice 5 resolves their pending awards, and Alpha Slice 6 adds Stage 2 Back Woods and High School. Alpha Slice 7 adds the audited Technical College branch and the Technician/Civilian and Technician/Vehicle Skill Fields. Alpha Slice 8 adds the audited Agitator Stage 4 branch and repeat-policy metadata. Alpha Slice 9 adds the audited final-review, threshold, Optimization, opposed-Trait, and negative-Trait purchase-cap foundation. Alpha Slice 10 adds the audited Final Touches, Wealth/C-bill, Equipped-rating, and Issued Gear foundation. Alpha Slice 11 adds the supplied 17-item starter Core equipment catalog. These slices do not add Companion templates or complete Life Module, Skill Field, or equipment catalogs. The historical First Printing is not included in the active runtime catalog.
