...
- Archetype customization beyond Slice 23's controlled Attribute and existing-Skill level adjustments. New-Skill swaps, Trait adjustments (including identity-based and parameterized cases), freeform/unbalanced completion, and GM overrides remain deferred. The implemented adjustment ledger must net to exactly 0 XP before save, export, or progression.
