...
- Broad Life Modules Workflow/UI Review remains deferred. Alpha Slice 26 resolves the queued Stage 0 issue by removing the implicit Mandarin Chinese / Capellan context default and requiring explicit affiliation context plus language choices; it does not redesign the remaining workflow.
