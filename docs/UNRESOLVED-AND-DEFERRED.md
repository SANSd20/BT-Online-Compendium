...
- Archetype customization beyond selecting one of the eight published Core foundations. Slice 22 adds read-only shared XP accounting and an empty durable adjustment ledger; equal-XP swaps, balanced increases/decreases, freeform editing, and GM overrides remain deferred.
